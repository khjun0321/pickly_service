...
class Announcement {
  ...
  /// Application start date (PRD v9.6.1 - replaces postedDate)
  final DateTime? applicationStartDate;

  /// Application end date (PRD v9.6.1)
  ...
  /// Creates an [Announcement] from Supabase JSON response (PRD v9.6.1 schema).
  ///
  ...
  factory Announcement.fromJson(Map<String, dynamic> json) {
    return Announcement(
      ...
      applicationEndDate: json['application_end_date'] != null
          ? DateTime.parse(json['application_end_date'] as String)
          : null,
