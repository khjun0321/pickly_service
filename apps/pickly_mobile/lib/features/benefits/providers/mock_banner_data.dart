  ...
  static List<CategoryBanner> getAllBanners() {
    ...
    return [
      ...
      CategoryBanner(
        ...
        linkTarget: '/policies/test-banner-2',
      linkType: 'internal',
        sortOrder: 2,
        isActive: true,
        createdAt: now,
      ...
      CategoryBanner(
        ...
        linkTarget: '/policies/test-banner-3',
      linkType: 'internal',
        sortOrder: 3,
        isActive: true,
        createdAt: now,
      ...
      CategoryBanner(
        id: 'mock-housing-1',
        benefitCategoryId: 'housing',
        title: '주거 배너 테스트 1',
        subtitle: '테스트 배너 이미지 1',
        imageUrl: 'assets/images/test/house_banner_test_01.png',
        backgroundColor: '#9C27B0',
        linkTarget: '/policies/housing-test-1',
      linkType: 'internal',
        sortOrder: 1,
        isActive: true,
        createdAt: now,
      ...
      CategoryBanner(
        ...
        linkTarget: '/policies/housing-test-2',
      linkType: 'internal',
        sortOrder: 2,
        isActive: true,
        createdAt: now,
      ...
      CategoryBanner(
        ...
        linkTarget: '/policies/housing-test-3',
      linkType: 'internal',
        sortOrder: 3,
        isActive: true,
        createdAt: now,
      ...
      CategoryBanner(
        ...
        linkTarget: '/policies/first-child-education',
      linkType: 'internal',
        sortOrder: 2,
        isActive: true,
        createdAt: now,
      ...
      CategoryBanner(
        ...
        linkTarget: '/policies/startup-support',
      linkType: 'internal',
        sortOrder: 2,
        isActive: true,
        createdAt: now,
      ...
      CategoryBanner(
        ...
        linkTarget: '/policies/child-allowance',
      linkType: 'internal',
        sortOrder: 2,
        isActive: true,
        createdAt: now,
      ...
      CategoryBanner(
        ...
        linkTarget: '/policies/senior-pension',
      linkType: 'internal',
        sortOrder: 3,
        isActive: true,
        createdAt: now,
