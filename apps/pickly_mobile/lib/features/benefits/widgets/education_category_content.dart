...
/// Education category content (교육 카테고리 컨텐츠)
///
/// Displays education-related policies and benefits with filter tabs
class EducationCategoryContent extends StatefulWidget {
  const EducationCategoryContent({super.key});

  @override
  State<EducationCategoryContent> createState() => _EducationCategoryContentState();
}

class _EducationCategoryContentState extends State<EducationCategoryContent> {
  ...
  List<Policy> _getFilteredPolicies() {
    final allPolicies = MockPolicyData.getPoliciesByCategory('education');
